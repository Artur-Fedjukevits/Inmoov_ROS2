...
def setup_var_protocol():
    ...
    return [1],['ultrasonicLeft_distance'],['std_msgs/Int16.msg'],[['int16']],[['data']],[[0]],[[1]],[[116]],[[2]]
...
class Publisher_node(Node):
    ...
    def __init__(self):
        super().__init__('xicro_publisher_node_subsys_left')
...
class Subscriber_node(Node):
    def __init__(self,Obj_uart):
        super().__init__('xicro_subscriber_node_subsys_left')
        self.Obj_uart = Obj_uart
        self.xicro_instruction = Xicro_instruction(self.Obj_uart)
        time.sleep(1)

        # gen sub
        #gen        self.subscription_thumb_L = self.create_subscription(Int16,'thumb_L',self.callback_thumb_L,10)        self.callback_thumb_L        self.subscription_index_L = self.create_subscription(Int16,'index_L',self.callback_index_L,10)        self.callback_index_L        self.subscription_majeure_L = self.create_subscription(Int16,'majeure_L',self.callback_majeure_L,10)        self.callback_majeure_L        self.subscription_ringFinger_L = self.create_subscription(Int16,'ringFinger_L',self.callback_ringFinger_L,10)        self.callback_ringFinger_L        self.subscription_pinky_L = self.create_subscription(Int16,'pinky_L',self.callback_pinky_L,10)        self.callback_pinky_L        self.subscription_wrist_L = self.create_subscription(Int16,'wrist_L',self.callback_wrist_L,10)        self.callback_wrist_L        self.subscription_bicep_L = self.create_subscription(Int16,'bicep_L',self.callback_bicep_L,10)        self.callback_bicep_L        self.subscription_rotate_L = self.create_subscription(Int16,'rotate_L',self.callback_rotate_L,10)        self.callback_rotate_L        self.subscription_shoulder_L = self.create_subscription(Int16,'shoulder_L',self.callback_shoulder_L,10)        self.callback_shoulder_L        self.subscription_omoplate_L = self.create_subscription(Int16,'omoplate_L',self.callback_omoplate_L,10)        self.callback_omoplate_L        self.subscription_neck = self.create_subscription(Int16,'neck',self.callback_neck,10)        self.callback_neck        self.subscription_rothead = self.create_subscription(Int16,'rothead',self.callback_rothead,10)        self.callback_rothead        self.subscription_eye_lr_L = self.create_subscription(Int16,'eye_lr_L',self.callback_eye_lr_L,10)        self.callback_eye_lr_L        self.subscription_eye_ud_L = self.create_subscription(Int16,'eye_ud_L',self.callback_eye_ud_L,10)        self.callback_eye_ud_L        self.subscription_jaw = self.create_subscription(Int16,'jaw',self.callback_jaw,10)        self.callback_jaw        self.subscription_topstom = self.create_subscription(Int16,'topstom',self.callback_topstom,10)        self.callback_topstom        self.subscription_midstom = self.create_subscription(Int16,'midstom',self.callback_midstom,10)        self.callback_midstom        self.subscription_lowstom = self.create_subscription(Int16,'lowstom',self.callback_lowstom,10)        self.callback_lowstom        self.subscription_ultrasonic_enable = self.create_subscription(Bool,'ultrasonic_enable',self.callback_ultrasonic_enable,10)        self.callback_ultrasonic_enable        self.subscription_ultrasonic_trigger = self.create_subscription(Bool,'ultrasonic_trigger',self.callback_ultrasonic_trigger,10)        self.callback_ultrasonic_trigger        self.subscription_eyelid_L_Upper = self.create_subscription(Int16,'eyelid_L_Upper',self.callback_eyelid_L_Upper,10)        self.callback_eyelid_L_Upper        self.subscription_eyelid_L_Lower = self.create_subscription(Int16,'eyelid_L_Lower',self.callback_eyelid_L_Lower,10)        self.callback_eyelid_L_Lower        self.subscription_eyelid_R_Upper = self.create_subscription(Int16,'eyelid_R_Upper',self.callback_eyelid_R_Upper,10)        self.callback_eyelid_R_Upper        self.subscription_eyelid_R_Lower = self.create_subscription(Int16,'eyelid_R_Lower',self.callback_eyelid_R_Lower,10)        self.callback_eyelid_R_Lower        self.subscription_eyebrow_L = self.create_subscription(Int16,'eyebrow_L',self.callback_eyebrow_L,10)        self.callback_eyebrow_L        self.subscription_eyebrow_R = self.create_subscription(Int16,'eyebrow_R',self.callback_eyebrow_R,10)        self.callback_eyebrow_R        self.subscription_cheek_L = self.create_subscription(Int16,'cheek_L',self.callback_cheek_L,10)        self.callback_cheek_L        self.subscription_cheek_R = self.create_subscription(Int16,'cheek_R',self.callback_cheek_R,10)        self.callback_cheek_R        self.subscription_forhead_L = self.create_subscription(Int16,'forhead_L',self.callback_forhead_L,10)        self.callback_forhead_L        self.subscription_forhead_R = self.create_subscription(Int16,'forhead_R',self.callback_forhead_R,10)        self.callback_forhead_R
    # gen callback sub
    # gen callback Sub    def callback_thumb_L(self,msg):        self.xicro_instruction._Reset_Buff()        self.xicro_instruction._Reset_CRC()        self.xicro_instruction._SendStart()        self.xicro_instruction._SendSignature(2,2)        self.xicro_instruction._SendIdtopic(1)        self.xicro_instruction._SendInt16(msg.data,1)
        self.xicro_instruction._SendStop()        self.xicro_instruction._SendCRC()        self.xicro_instruction._To_Send()        return 1    def callback_index_L(self,msg):        self.xicro_instruction._Reset_Buff()        self.xicro_instruction._Reset_CRC()        self.xicro_instruction._SendStart()        self.xicro_instruction._SendSignature(2,2)        self.xicro_instruction._SendIdtopic(2)        self.xicro_instruction._SendInt16(msg.data,1)
        self.xicro_instruction._SendStop()        self.xicro_instruction._SendCRC()        self.xicro_instruction._To_Send()        return 1    def callback_majeure_L(self,msg):        self.xicro_instruction._Reset_Buff()        self.xicro_instruction._Reset_CRC()        self.xicro_instruction._SendStart()        self.xicro_instruction._SendSignature(2,2)        self.xicro_instruction._SendIdtopic(3)        self.xicro_instruction._SendInt16(msg.data,1)
        self.xicro_instruction._SendStop()        self.xicro_instruction._SendCRC()        self.xicro_instruction._To_Send()        return 1    def callback_ringFinger_L(self,msg):        self.xicro_instruction._Reset_Buff()        self.xicro_instruction._Reset_CRC()        self.xicro_instruction._SendStart()        self.xicro_instruction._SendSignature(2,2)        self.xicro_instruction._SendIdtopic(4)        self.xicro_instruction._SendInt16(msg.data,1)
        self.xicro_instruction._SendStop()        self.xicro_instruction._SendCRC()        self.xicro_instruction._To_Send()        return 1    def callback_pinky_L(self,msg):        self.xicro_instruction._Reset_Buff()        self.xicro_instruction._Reset_CRC()        self.xicro_instruction._SendStart()        self.xicro_instruction._SendSignature(2,2)        self.xicro_instruction._SendIdtopic(5)        self.xicro_instruction._SendInt16(msg.data,1)
        self.xicro_instruction._SendStop()        self.xicro_instruction._SendCRC()        self.xicro_instruction._To_Send()        return 1    def callback_wrist_L(self,msg):        self.xicro_instruction._Reset_Buff()        self.xicro_instruction._Reset_CRC()        self.xicro_instruction._SendStart()        self.xicro_instruction._SendSignature(2,2)        self.xicro_instruction._SendIdtopic(6)        self.xicro_instruction._SendInt16(msg.data,1)
        ...
        self.xicro_instruction._SendStop()        self.xicro_instruction._SendCRC()        self.xicro_instruction._To_Send()        return 1    def callback_eye_lr_L(self,msg):        self.xicro_instruction._Reset_Buff()        self.xicro_instruction._Reset_CRC()        self.xicro_instruction._SendStart()        self.xicro_instruction._SendSignature(2,2)        self.xicro_instruction._SendIdtopic(13)        self.xicro_instruction._SendInt16(msg.data,1)
        self.xicro_instruction._SendStop()        self.xicro_instruction._SendCRC()        self.xicro_instruction._To_Send()        return 1    def callback_eye_ud_L(self,msg):        self.xicro_instruction._Reset_Buff()        self.xicro_instruction._Reset_CRC()        self.xicro_instruction._SendStart()        self.xicro_instruction._SendSignature(2,2)        self.xicro_instruction._SendIdtopic(14)        self.xicro_instruction._SendInt16(msg.data,1)
        self.xicro_instruction._SendStop()        self.xicro_instruction._SendCRC()        self.xicro_instruction._To_Send()        return 1    def callback_jaw(self,msg):        self.xicro_instruction._Reset_Buff()        self.xicro_instruction._Reset_CRC()        self.xicro_instruction._SendStart()        self.xicro_instruction._SendSignature(2,2)        self.xicro_instruction._SendIdtopic(15)        self.xicro_instruction._SendInt16(msg.data,1)
        self.xicro_instruction._SendStop()        self.xicro_instruction._SendCRC()        self.xicro_instruction._To_Send()        return 1    def callback_topstom(self,msg):        self.xicro_instruction._Reset_Buff()        self.xicro_instruction._Reset_CRC()        self.xicro_instruction._SendStart()        self.xicro_instruction._SendSignature(2,2)        self.xicro_instruction._SendIdtopic(16)        self.xicro_instruction._SendInt16(msg.data,1)
        self.xicro_instruction._SendStop()        self.xicro_instruction._SendCRC()        self.xicro_instruction._To_Send()        return 1    def callback_midstom(self,msg):        self.xicro_instruction._Reset_Buff()        self.xicro_instruction._Reset_CRC()        self.xicro_instruction._SendStart()        self.xicro_instruction._SendSignature(2,2)        self.xicro_instruction._SendIdtopic(17)        self.xicro_instruction._SendInt16(msg.data,1)
        self.xicro_instruction._SendStop()        self.xicro_instruction._SendCRC()        self.xicro_instruction._To_Send()        return 1    def callback_lowstom(self,msg):        self.xicro_instruction._Reset_Buff()        self.xicro_instruction._Reset_CRC()        self.xicro_instruction._SendStart()        self.xicro_instruction._SendSignature(2,2)        self.xicro_instruction._SendIdtopic(18)        self.xicro_instruction._SendInt16(msg.data,1)
        self.xicro_instruction._SendStop()        self.xicro_instruction._SendCRC()        self.xicro_instruction._To_Send()        return 1    def callback_ultrasonic_enable(self,msg):        self.xicro_instruction._Reset_Buff()        self.xicro_instruction._Reset_CRC()        self.xicro_instruction._SendStart()        self.xicro_instruction._SendSignature(2,2)        self.xicro_instruction._SendIdtopic(19)        self.xicro_instruction._SendBool(msg.data,1,False)
# auto by 1 bool
        self.xicro_instruction._SendCRC()        self.xicro_instruction._To_Send()        return 1    def callback_ultrasonic_trigger(self,msg):        self.xicro_instruction._Reset_Buff()        self.xicro_instruction._Reset_CRC()        self.xicro_instruction._SendStart()        self.xicro_instruction._SendSignature(2,2)        self.xicro_instruction._SendIdtopic(20)        self.xicro_instruction._SendBool(msg.data,1,False)
# auto by 1 bool
        self.xicro_instruction._SendCRC()        self.xicro_instruction._To_Send()        return 1    def callback_eyelid_L_Upper(self,msg):        self.xicro_instruction._Reset_Buff()        self.xicro_instruction._Reset_CRC()        self.xicro_instruction._SendStart()        self.xicro_instruction._SendSignature(2,2)        self.xicro_instruction._SendIdtopic(21)        self.xicro_instruction._SendInt16(msg.data,1)
        self.xicro_instruction._SendStop()        self.xicro_instruction._SendCRC()        self.xicro_instruction._To_Send()        return 1    def callback_eyelid_L_Lower(self,msg):        self.xicro_instruction._Reset_Buff()        self.xicro_instruction._Reset_CRC()        self.xicro_instruction._SendStart()        self.xicro_instruction._SendSignature(2,2)        self.xicro_instruction._SendIdtopic(22)        self.xicro_instruction._SendInt16(msg.data,1)
        self.xicro_instruction._SendStop()        self.xicro_instruction._SendCRC()        self.xicro_instruction._To_Send()        return 1    def callback_eyelid_R_Upper(self,msg):        self.xicro_instruction._Reset_Buff()        self.xicro_instruction._Reset_CRC()        self.xicro_instruction._SendStart()        self.xicro_instruction._SendSignature(2,2)        self.xicro_instruction._SendIdtopic(23)        self.xicro_instruction._SendInt16(msg.data,1)
        self.xicro_instruction._SendStop()        self.xicro_instruction._SendCRC()        self.xicro_instruction._To_Send()        return 1    def callback_eyelid_R_Lower(self,msg):        self.xicro_instruction._Reset_Buff()        self.xicro_instruction._Reset_CRC()        self.xicro_instruction._SendStart()        self.xicro_instruction._SendSignature(2,2)        self.xicro_instruction._SendIdtopic(24)        self.xicro_instruction._SendInt16(msg.data,1)
        self.xicro_instruction._SendStop()        self.xicro_instruction._SendCRC()        self.xicro_instruction._To_Send()        return 1    def callback_eyebrow_L(self,msg):        self.xicro_instruction._Reset_Buff()        self.xicro_instruction._Reset_CRC()        self.xicro_instruction._SendStart()        self.xicro_instruction._SendSignature(2,2)        self.xicro_instruction._SendIdtopic(25)        self.xicro_instruction._SendInt16(msg.data,1)
        self.xicro_instruction._SendStop()        self.xicro_instruction._SendCRC()        self.xicro_instruction._To_Send()        return 1    def callback_eyebrow_R(self,msg):        self.xicro_instruction._Reset_Buff()        self.xicro_instruction._Reset_CRC()        self.xicro_instruction._SendStart()        self.xicro_instruction._SendSignature(2,2)        self.xicro_instruction._SendIdtopic(26)        self.xicro_instruction._SendInt16(msg.data,1)
        self.xicro_instruction._SendStop()        self.xicro_instruction._SendCRC()        self.xicro_instruction._To_Send()        return 1    def callback_cheek_L(self,msg):        self.xicro_instruction._Reset_Buff()        self.xicro_instruction._Reset_CRC()        self.xicro_instruction._SendStart()        self.xicro_instruction._SendSignature(2,2)        self.xicro_instruction._SendIdtopic(27)        self.xicro_instruction._SendInt16(msg.data,1)
        self.xicro_instruction._SendStop()        self.xicro_instruction._SendCRC()        self.xicro_instruction._To_Send()        return 1    def callback_cheek_R(self,msg):        self.xicro_instruction._Reset_Buff()        self.xicro_instruction._Reset_CRC()        self.xicro_instruction._SendStart()        self.xicro_instruction._SendSignature(2,2)        self.xicro_instruction._SendIdtopic(28)        self.xicro_instruction._SendInt16(msg.data,1)
        self.xicro_instruction._SendStop()        self.xicro_instruction._SendCRC()        self.xicro_instruction._To_Send()        return 1    def callback_forhead_L(self,msg):        self.xicro_instruction._Reset_Buff()        self.xicro_instruction._Reset_CRC()        self.xicro_instruction._SendStart()        self.xicro_instruction._SendSignature(2,2)        self.xicro_instruction._SendIdtopic(29)        self.xicro_instruction._SendInt16(msg.data,1)
        self.xicro_instruction._SendStop()        self.xicro_instruction._SendCRC()        self.xicro_instruction._To_Send()        return 1    def callback_forhead_R(self,msg):        self.xicro_instruction._Reset_Buff()        self.xicro_instruction._Reset_CRC()        self.xicro_instruction._SendStart()        self.xicro_instruction._SendSignature(2,2)        self.xicro_instruction._SendIdtopic(30)        self.xicro_instruction._SendInt16(msg.data,1)
        self.xicro_instruction._SendStop()        self.xicro_instruction._SendCRC()        self.xicro_instruction._To_Send()        return 1
...
class Uart():
    def __init__(self,mp):
        ...
        if( input.serial_port != None):
            ...
            self.port = "/dev/serial/by-path/pci-0000:c6:00.3-usb-0:1.4:1.0-port0"
...
class Srv_client_node(Node):
    def __init__(self,Obj_uart,OnIdsrv,Ongrab,sequence):
        super().__init__('xicro_service_client_node_subsys_left_'+str(sequence))        # gen Id mcu
        self.Idmcu = 2
        self.Obj_uart = Obj_uart
        self.xicro_instruction = Xicro_instruction(self.Obj_uart)
        self.Ongrab=Ongrab
...
class Action_client_node(Node):
    def __init__(self,Obj_uart,OnIdaction,Ongrab,sequence):
        super().__init__('xicro_action_client_node_subsys_left_'+str(sequence))        # gen Id mcu
        self.Idmcu = 2
        self.Obj_uart = Obj_uart
        self.xicro_instruction = Xicro_instruction(self.Obj_uart)
        self.Ongrab=Ongrab
